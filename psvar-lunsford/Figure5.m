%==========================================================================
% This script produces Figure 5 of "Proxy SVARs: Asymptotic Theory, 
...
IRF_confidence68(:,:,1,1) =...
    IRF_bootSort(:,:,round(nBoot*0.14),1);
IRF_confidence68(:,:,2,1) =...
    IRF_bootSort(:,:,round(nBoot*0.86),1);
IRF_confidence68(:,:,1,2) =...
    IRF_bootSort(:,:,round(nBoot*0.14),2);
IRF_confidence68(:,:,2,2) =...
    IRF_bootSort(:,:,round(nBoot*0.86),2);
...
xlim([1,nImp])
xlabel('Quarters')
title('Nonresidential Investment')
